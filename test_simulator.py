...
print("🚀 Enviando telemetría de prueba a EcoGrid-Link...")

# 1. Enviar lectura normal (2.5 W)
payload_normal = {"id_nodo": "esp32_maqueta_casa1", "voltaje": 5.0, "corriente": 0.5}
client.publish(TOPIC, json.dumps(payload_normal))
print(f"Sent: {payload_normal}")
time.sleep(2)

# 2. Enviar lectura de sobrecarga (60 W)
payload_sobrecarga = {"id_nodo": "esp32_maqueta_casa1", "voltaje": 12.0, "corriente": 5.0}
